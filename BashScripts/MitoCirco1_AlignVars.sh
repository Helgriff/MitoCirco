...
READ_FILE1gz=( $INDIR/${SAMPLE_ID}${FQS1} )
READ_FILE2gz=( $INDIR/${SAMPLE_ID}${FQS2} )
READ_FILE1=( $INDIR/${SAMPLE_ID}_R1_001.fastq )
READ_FILE2=( $INDIR/${SAMPLE_ID}_R2_001.fastq )
READ_FILE1_nodup="$INDIR/${SAMPLE_ID}_R1_001.nodup.fastq"
READ_FILE2_nodup="$INDIR/${SAMPLE_ID}_R2_001.nodup.fastq"
FASTQ_LIST_FILE="$INDIR/${SAMPLE_ID}.temp.qlist"
...
################## BWA Alignment ####################
SAM_FILE1hg38="$WRKGDIR/${SAMPLE_ID}_hg38.sam"
RAW_BAMhg38="$SAM_FILE1hg38.bam"
READNAMEShg38nc="$INDIR/${SAMPLE_ID}_hg38nc.reads"
SAM_FILE1hg38mt="$WRKGDIR/${SAMPLE_ID}_hg38mt.sam"
DUP_FREE_BAMhg38="${DUP_FREE_BAM_DIR}/${SAMPLE_ID}_nodups_${REF_BUILD}.bam"

SAM_FILE1hg38plus="$WRKGDIR/${SAMPLE_ID}_hg38plus.sam"
RAW_BAMhg38plus="$SAM_FILE1hg38plus.bam"
READNAMEShg38plusnc="$INDIR/${SAMPLE_ID}_hg38plusnc.reads"
SAM_FILE1hg38plusmt="$WRKGDIR/${SAMPLE_ID}_hg38plusmt.sam"
DUP_FREE_BAMhg38plus="${DUP_FREE_BAM_DIR}/${SAMPLE_ID}_nodups_${REF_BUILD}plus.bam"

SAM_FILE1rCRS="$WRKGDIR/${SAMPLE_ID}_rCRS.sam"
